...
A calculadora estima as verbas rescisórias da CLT em 2026 conforme o tipo de saída: **saldo de salário = (salário ÷ 30) × dias trabalhados**, aviso prévio de 30 dias + 3 por ano (até 90, Lei nº 12.506/2011), 13º e férias proporcionais com 1/3 e multa de 40% do FGTS na demissão sem justa causa.

| Item | Valor |
| --- | --- |
| Aviso prévio (Lei nº 12.506/2011) | 30 dias + 3 por ano de serviço (máx. 90) |
| Multa do FGTS sem justa causa | 40% do saldo |
| Multa do FGTS no acordo mútuo | 20% do saldo (e metade do aviso) |
...
Para detalhar números específicos, vale usar também a [Calculadora de Salário Líquido](/c/calculadora-salario-liquido) (para o desconto mensal de INSS e IRRF), a [Calculadora de FGTS](/c/calculadora-fgts) (para estimar o saldo que serve de base à multa) e a [Calculadora de Aviso Prévio](/c/calculadora-aviso-previo). Você pode acompanhar essas e outras ferramentas trabalhistas no [blog](/blog) e ver como verificamos cada número na página [Sobre](/about).
