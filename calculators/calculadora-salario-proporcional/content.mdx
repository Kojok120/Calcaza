...
A calculadora estima o salário de quem trabalhou só parte do mês: **salário proporcional = (salário mensal ÷ 30) × dias trabalhados**. O divisor 30 segue o mês comercial da CLT (art. 64), e também é possível usar os dias corridos do mês (28 a 31), conforme orientações do Ministério do Trabalho e Emprego.

| Item | Valor |
| --- | --- |
| Fórmula | (salário mensal ÷ 30) × dias trabalhados |
| Divisor padrão (CLT, art. 64) | 30 dias |
| Alternativa por dias corridos | 28 a 31 dias |
| Avo de férias e 13º | conta o mês com 15 dias ou mais |
