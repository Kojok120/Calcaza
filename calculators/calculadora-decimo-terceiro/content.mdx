...
Para estimar o que cai na conta todo mês, use a [Calculadora de Salário Líquido](/c/calculadora-salario-liquido). A Calcaza está montando uma série de calculadoras trabalhistas — INSS, IRRF, FGTS, férias e rescisão — sempre com a fonte oficial citada. Acompanhe os guias no [blog](/blog) e veja como verificamos cada número na página [Sobre](/about).
