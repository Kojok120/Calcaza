...
A calculadora projeta o montante de CDB, Tesouro Direto ou poupança com aportes mensais por juros compostos: **M = C × (1 + i)^n + A × [((1 + i)^n − 1) ÷ i]**. Sobre o rendimento da renda fixa incide o IR regressivo da Lei nº 11.033/2004, de 22,5% a 15%; a poupança (0,5% ao mês) é isenta.

| Item | Valor |
| --- | --- |
| IR: resgate em até 180 dias | 22,5% do rendimento |
| IR: de 181 a 360 dias | 20% |
| IR: de 361 a 720 dias | 17,5% |
| IR: acima de 720 dias | 15% |
| Poupança (Selic acima de 8,5% a.a.) | 0,5% ao mês + TR, isenta de IR |
