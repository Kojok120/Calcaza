...
Para ver quanto sobra no fim do mês com o salário e as horas extras somados, use a [Calculadora de Salário Líquido](/c/calculadora-salario-liquido). Você também pode acompanhar nossos guias no [blog](/blog) e conferir como verificamos cada número na página [Sobre](/about).
