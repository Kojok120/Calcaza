...
Esta calculadora estima o valor bruto das horas extras: a hora normal (salário ÷ jornada, divisor padrão 220) acrescida do adicional mínimo de 50% — ou de 100% em domingos e feriados não compensados, conforme a Constituição (art. 7º, XVI) e a Súmula 146 do TST — com reflexo opcional no DSR.

| Item | Valor |
| --- | --- |
| Adicional mínimo | 50% sobre a hora normal (CF, art. 7º, XVI) |
| Domingos e feriados não compensados | 100% (Súmula 146 do TST) |
| Divisor de jornada padrão | 220 horas mensais |
| Reflexo no DSR (padrão) | dias de descanso ÷ dias úteis (5 ÷ 25) |
