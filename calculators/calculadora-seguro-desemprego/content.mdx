...
Se você foi dispensado, vale conferir também o que tem a receber na saída. Use a [Calculadora de Salário Líquido](/c/calculadora-salario-liquido) para entender INSS e IRRF na folha, e acompanhe os guias trabalhistas no [blog](/blog). Para saber como verificamos cada número, veja a página [Sobre](/about).
