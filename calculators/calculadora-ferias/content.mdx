...
Esta calculadora estima o valor líquido das férias: o salário bruto dividido por 30 e multiplicado pelos dias gozados, mais o terço constitucional (1/3, Constituição, art. 7º, XVII), com descontos de INSS e IRRF pelas tabelas de 2026 da Receita Federal e do INSS. O abono pecuniário (10 dias vendidos) é isento.

| Item | Valor |
| --- | --- |
| Férias gozadas | (salário bruto ÷ 30) × dias de férias |
| Terço constitucional | 1/3 sobre as férias (CF, art. 7º, XVII) |
| Abono pecuniário (CLT, art. 143) | 10 dias vendidos, isentos de INSS e IRRF |
...
**3. 30 dias, salário R$ 5.000, 2 dependentes.** A base sobe para R$ 6.666,67. Com os dependentes reduzindo a base do IRRF, o imposto cai para perto de R$ 618,25 e o líquido fica em torno de R$ 5.313,57.
...
Para entender o salário mês a mês, use a [Calculadora de Salário Líquido](/c/calculadora-salario-liquido), que aplica os mesmos descontos de INSS e IRRF de 2026. Veja também a [Calculadora de 13º Salário](/c/calculadora-decimo-terceiro) e a [Calculadora de Rescisão CLT](/c/calculadora-rescisao). Você também pode acompanhar os guias trabalhistas no [blog](/blog) e ver como conferimos cada número na página [Sobre](/about).
